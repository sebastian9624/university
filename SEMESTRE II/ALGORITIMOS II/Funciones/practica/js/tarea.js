...
function numerosRepetidosArray (array, numero){
    const arrayPosiciones = [];
    if (Number.isInteger(numero)) {
        ...
        for (let index = 0; index < array.length; index++) {
            ...
            console.log('El número ' + numero + ' se encuentra en las posiciones ' + arrayPosiciones);
        }
    } else {
...
numerosRepetidosArray(arrayNumeros, numBusqueda);