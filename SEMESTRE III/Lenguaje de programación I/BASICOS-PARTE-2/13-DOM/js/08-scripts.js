...
// Todo en JavaScript esta conectado en el document, la forma
//  en que te moverás entre diferentes elementos se le conoce 
// como Traversing the DOM, ir recorriendolo..


const navegacion = document.querySelector('.navegacion');
console.log(navegacion);

// Cada elemento en la navegación los diferentes
//  elementos se les conoce como Nodos... y podrás
//  listarlos de la siguiente forma...
...
// En el archivo anterior vimos como hacer traversing de un elemento padre hacia el hijo, JavaScript también te permite seleccionar un elemento hijo e ir navegando hacia el padre...
